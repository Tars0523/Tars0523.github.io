...
[지난 (1)편](/posts/GNC/)에서는 robust estimation의 기본 문제 설정을 정리했다. 핵심은, 단순한 least squares인 식 (1)에 robust kernel $\rho(\cdot)$를 씌운 식 (2)가 *outlier*에 강건해지는 대신, *non-convexity* 때문에 *local optimum* 문제가 생긴다는 것이었다.
